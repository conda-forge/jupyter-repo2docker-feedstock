...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3037&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyter-repo2docker-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyter-repo2docker` can be installed with `conda`:
...
```
mamba install jupyter-repo2docker
```

It is possible to list all of the versions of `jupyter-repo2docker` available on your platform with `conda`:
...
```
mamba search jupyter-repo2docker --channel conda-forge
```
...
mamba repoquery search jupyter-repo2docker --channel conda-forge

# List packages depending on `jupyter-repo2docker`:
mamba repoquery whoneeds jupyter-repo2docker --channel conda-forge

# List dependencies of `jupyter-repo2docker`:
mamba repoquery depends jupyter-repo2docker --channel conda-forge
```
